...
const render = (
    ...
    if (typeof reactElement === 'string' | typeof reactElement === 'number') {
        ...
        // Assignment if it is function component
            ...
            // console.log("inside function ", type(props));
            // since type is a function, calling it reveals the JSX, which can be retrieved using my render function
            // where it will go to the else statement to create the html elements
